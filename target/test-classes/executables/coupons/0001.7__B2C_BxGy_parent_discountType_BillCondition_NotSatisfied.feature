...
Feature: BxGy parent mark redeem flow __0001.7
  ...
  Background:
    ...
    * def sku_price = apiComponents["B2C_BxGy_parent_discountType_responseData__0001.6"].skuPrice1
    * def bill_Amount = apiComponents["B2C_BxGy_parent_discountType_responseData__0001.6"].billAmount_notsatisfyingcondition
  #  * print #(bill_Amount)
