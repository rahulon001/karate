Feature: B2C flat discount on SKU return flow discount type__0041.1
  ...
  Background:
    ...
    * json result = callonce read("B2C_B2B_CouponCodeGeneration.feature@B2C_flat_discount_on_SKU")
  ...
  Scenario: merchant verify b2c flat discount on SKU __0041.1.
    ...
    * match response.data[0].discount == apiComponents["B2C_flat_discount_on_SKU_discountType_responseData__0041"].discount1
    ...
    * match response.newBillAmount == apiComponents["B2C_flat_discount_on_SKU_discountType_responseData__0041"].newBillAmount
  ...
  Scenario: merchant checkout b2c flat discount on SKU __0041.1.
    * def body =
    """
      {
        "masId": "#(masid)",
  ...
  Scenario: merchant accept-order b2c flat discount on SKU __0041.1.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant delivered-order b2c flat discount on SKU __0041.1.
    * def body =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant return-order b2c flat discount on SKU __0041.1.
    * header x-client-type = "mpos"
    * def body  =
    """
    {
      "masId": "#(masid)",
      "discountedBillAmount": #(apiComponents["B2C_flat_discount_on_SKU_discountType_responseData__0041"].newBillAmount),
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_flat_discount_on_SKU_discountType__0041"].skuData),
      "returnedItems": #(apiComponents["B2C_flat_discount_on_SKU_discountType__0041"].skuData)
    }
    """
...
#    * call sleep 30
  ...
  Scenario: merchant order-returned b2c flat discount on SKU __0041.1.
    * header x-client-type = "mpos"
    * def body =
    """
    {
