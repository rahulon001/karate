Feature: BxGy B2B mark redeem flow child __0002.2
  ...
  Background:
    ...
    * def b2c_discount_coupon_redemption = callonce read("0002__B2C_BxGy_child_mark_redeem_flow_discountType.feature@bxgy_child")
  ...
  Scenario: B2B coupon code getEligible __0002.2.
  ...
  Scenario: B2B coupon code release getEligible __0002.2.
    ...
    * json result = call read("B2C_B2B_CouponCodeGeneration.feature@B2B_BxGy_child_cart_redemption") {requestHeader: #(headerJson)}
  ...
  Scenario: B2B coupon code checkout __0002.2.
  ...
  Scenario: B2B coupon code deliver __0002.2
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: B2B coupon code mark redeem __0002.2
    * def body  =
    """
    {
    }
