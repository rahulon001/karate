Feature: BxGy_parent_percentage_off_mark_redeem_flow_discount_type __0009.6
  ...
  Background:
    ...
    * def sku_price = apiComponents["B2C_BxGy_parent_flat_off_discountType_responseData__0009"].less_price
    * json result = callonce read("B2C_B2B_CouponCodeGeneration.feature@BxGy_flat_parent_cart_lessprice") {requestHeader: #(headerJson) , skuPrice: #(sku_price)}
  ...
  Scenario: merchant verify b2c BxGy parent percentage off __0009.6.
    * def body =
    """
      {
        "masId": "#(masid)",
...
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_parent_flat_off_discountType_responseData__0009"].discountType1
    * match response.data[0].discount == apiComponents["B2C_BxGy_parent_flat_off_discountType_responseData__0009"].less_price_discount
    ...
    * match response.discountedItems[0].skuPrice == apiComponents["B2C_BxGy_parent_flat_off_discountType_responseData__0009"].less_price_skuPrice
    * match response.newBillAmount == apiComponents["B2C_BxGy_parent_flat_off_discountType_responseData__0009"].less_price_newBillAmount
  ...
  Scenario: merchant checkout b2c BxGy parent percentage off__0009.6.
    * def body =
    """
      {
        "masId": "#(masid)",
...
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_parent_flat_off_discountType_responseData__0009"].discountType1
  ...
  Scenario: merchant accept-order b2c BxGy parent percentage off__0009.6.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant delivered-order b2c BxGy parent percentage off__0009.6.
    * def body =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant mark redeem b2c BxGy parent percentage off__0009.6.
    * def body  =
    """
    {
