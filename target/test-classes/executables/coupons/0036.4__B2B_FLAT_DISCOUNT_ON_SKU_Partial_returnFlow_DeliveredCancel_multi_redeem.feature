Feature: B2B_FLAT_DISCOUNT_ON_SKU partial return flow multi redeem __0036.4
  ...
  Background:
    ...
    * def sku_data = apiComponents.B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption__0036.skuData
    ...
    * print "skuID_index_811143212221>", skuID_index_811143212221
    * def skuID_index_811143212223 = skuID.indexOf("811143212223")
    * print "skuID_index_811143212223>", skuID_index_811143212223
    * def skuID_index_811143212222 = skuID.indexOf("811143212222")
    * print "skuID_index_811143212222>", skuID_index_811143212222

    * def couponCode1 = result.response["skuCoupons"][skuID_index_811143212221]["coupons"][0]["couponCode"]
    * print "couponCode1>", couponCode1
    * def couponCode2 = result.response["skuCoupons"][skuID_index_811143212223]["coupons"][0]["couponCode"]
    * print "couponCode2>", couponCode2
    * def couponCode3 = result.response["skuCoupons"][skuID_index_811143212222]["coupons"][0]["couponCode"]
    * print "couponCode3>", couponCode3

    * assert result.response["skuCoupons"][skuID_index_811143212221]["coupons"][0]["couponQty"] == apiComponents.B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption_responseData__0036.couponQty_mr_811143212221
    * assert result.response["skuCoupons"][skuID_index_811143212223]["coupons"][0]["couponQty"] == apiComponents.B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption_responseData__0036.couponQty_mr_811143212223
    * assert result.response["skuCoupons"][skuID_index_811143212222]["coupons"][0]["couponQty"] == apiComponents.B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption_responseData__0036.couponQty_mr_811143212222

    * def couponCode1 = result.response["skuCoupons"][skuID_index_811143212221]["coupons"][0]["couponCode"]
    * def couponQuantity1 = result.response["skuCoupons"][skuID_index_811143212221]["coupons"][0]["couponQty"]
    * def couponCode2 = result.response["skuCoupons"][skuID_index_811143212223]["coupons"][0]["couponCode"]
    * def couponQuantity2 = result.response["skuCoupons"][skuID_index_811143212223]["coupons"][0]["couponQty"]
    * def couponCode3 = result.response["skuCoupons"][skuID_index_811143212222]["coupons"][0]["couponCode"]
    * def couponQuantity3 = result.response["skuCoupons"][skuID_index_811143212222]["coupons"][0]["couponQty"]
    ...
    * assert result.response["skuCoupons"][skuID_index_811143212221]["coupons"][0].discount == apiComponents["B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption_responseData__0036"].discount_mr_811143212221
    * assert result.response["skuCoupons"][skuID_index_811143212223]["coupons"][0].discount == apiComponents["B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption_responseData__0036"].discount_mr_811143212223
    * assert result.response["skuCoupons"][skuID_index_811143212222]["coupons"][0].discount == apiComponents["B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption_responseData__0036"].discount_mr_811143212222

    * assert result.response["skuCoupons"][skuID_index_811143212221]["coupons"][0].quantity == apiComponents["B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption_responseData__0036"].sku_quantity_per_unit_mr_811143212221
    * assert result.response["skuCoupons"][skuID_index_811143212223]["coupons"][0].quantity == apiComponents["B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption_responseData__0036"].sku_quantity_per_unit_mr_811143212223
    * assert result.response["skuCoupons"][skuID_index_811143212222]["coupons"][0].quantity == apiComponents["B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption_responseData__0036"].sku_quantity_per_unit_mr_811143212222
  ...
  Scenario: B2B_FLAT_DISCOUNT_ON_SKU checkout partial return flow multi redeem __0036.4.
    * def coupon_id_811143212221 = db.readRows("SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212221+ "\')")
    * def coupon_id_811143212223 = db.readRows("SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212223+ "\')")
    * def coupon_id_811143212222 = db.readRows("SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212222+ "\')")

     * def coupon_code_status = db.readRows("SELECT * FROM FC_MERCHANT_COUPONS WHERE B2B_COUPON_ID IN (\'" +coupon_id_811143212221[0].ID+ "\',\'" +coupon_id_811143212223[0].ID+ "\',\'" +coupon_id_811143212222[0].ID+ "\') and status='hold'")
  ...
  Scenario: B2B_FLAT_DISCOUNT_ON_SKU checkout partial return flow multi redeem __0036.4.
    ...
    * assert response.data[coupon_code.indexOf(couponCode1)].discount == apiComponents["B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption_responseData__0036"].discount_mr_811143212221
    * assert response.data[coupon_code.indexOf(couponCode2)].discount == apiComponents["B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption_responseData__0036"].discount_mr_811143212223
    * assert response.data[coupon_code.indexOf(couponCode3)].discount == apiComponents["B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption_responseData__0036"].discount_mr_811143212222

    * assert response.data[coupon_code.indexOf(couponCode1)].quantity == apiComponents.B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption_responseData__0036.couponQty_mr_811143212221
    * assert response.data[coupon_code.indexOf(couponCode2)].quantity == apiComponents.B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption_responseData__0036.couponQty_mr_811143212223
    * assert response.data[coupon_code.indexOf(couponCode3)].quantity == apiComponents.B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption_responseData__0036.couponQty_mr_811143212222

  Scenario: B2B_FLAT_DISCOUNT_ON_SKU delivered partial return flow multi redeem __0036.4
  ...
  Scenario: B2B_FLAT_DISCOUNT_ON_SKU delayed cancel partial return flow multi redeem __0036.4
     # redemption count
    * def redeem_quantity_811143212221 = db.readRows("SELECT QUANTITY FROM B2B_COUPON_REDEMPTION WHERE B2B_COUPON_ID IN (SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212221+ "\')) and masid=\'" +masid+ "\'")
    * def redeem_quantity_811143212223 = db.readRows("SELECT QUANTITY FROM B2B_COUPON_REDEMPTION WHERE B2B_COUPON_ID IN (SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212223+ "\')) and masid=\'" +masid+ "\'")
    * def redeem_quantity_811143212222 = db.readRows("SELECT QUANTITY FROM B2B_COUPON_REDEMPTION WHERE B2B_COUPON_ID IN (SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212222+ "\')) and masid=\'" +masid+ "\'")
    ...
    * match parseInt(redeem_quantity_811143212222_r[0].QUANTITY) == parseInt(redeem_quantity_811143212222[0].QUANTITY)
    ...
    * match parseInt(redeem_count_811143212222_r[0].REDEEM_COUNT) == parseInt(redeem_count_811143212222[0].REDEEM_COUNT)


  Scenario: B2B_FLAT_DISCOUNT_ON_SKU redeem partial return flow multi redeem __0036.4
    * def body  =
    """
    {
    }
  ...
  Scenario: B2B_FLAT_DISCOUNT_ON_SKU checkout of cancelled coupons in partial return flow multi redeem __0036.4
    * def body =
    """
      {
      "masId": "#(masid)",
  ...
  Scenario: Switching off the features __0036.4.
