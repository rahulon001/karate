Feature: B2B_FLAT_DISCOUNT_ON_SKU MarkRedemptionFlow __0036
  ...
  Background:
    ...
    * def bill_amount = apiComponents["B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption__0036.12"].billAmount
    ...
    * def skuID_index_811143212220 = skuID.indexOf("811143212220")
  ...
  Scenario: B2B_FLAT_DISCOUNT_ON_SKU verifying hold status __0036.
  ...
  Scenario: B2B_FLAT_DISCOUNT_ON_SKU checkout Mark Redemption Flow __0036.
    ...
    * assert response.discountAmount == apiComponents["B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption_responseData__0036.12"].discountAmount
    * assert response.newBillAmount == apiComponents["B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption_responseData__0036.12"].newBillAmount
#    * match each response.data[*].discountType == apiComponents["B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption_responseData__0036.12"].discountType
  ...
  Scenario: B2B_FLAT_DISCOUNT_ON_SKU delivered Mark Redemption Flow __0036.
    ...
    * def update_delivered_TS = db.updateRow("UPDATE FC_MERCHANT_COUPONS SET DELIVERED_TS = CURRENT_TIMESTAMP - 20 WHERE MERCHANT_COUPON_CODE IN (\'" +couponCode1+ "\',\'" +couponCode2+ "\',\'" +couponCode3+ "\',\'" +couponCode4+ "\',\'" +couponCode5+ "\',\'" +couponCode6+ "\',\'" +couponCode7+ "\',\'" +couponCode8+ "\',\'" +couponCode9+ "\',\'" +couponCode10+ "\',\'" +couponCode11+ "\',\'" +couponCode12+ "\',\'" +couponCode13+ "\',\'" +couponCode14+ "\',\'" +couponCode15+ "\',\'" +couponCode16+ "\')")
  ...
  Scenario: B2B_FLAT_DISCOUNT_ON_SKU delayed cancel partial return flow __0036.1
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1), #(couponCode2), #(couponCode7), #(couponCode8), #(couponCode16)],
      "coupons" : [],
      "masId": "#(masid)",
     }
    """
    ...
    When method post
    Then status 200
    * def coupon_code_status = db.readRows("SELECT * FROM FC_MERCHANT_COUPONS WHERE MERCHANT_COUPON_CODE IN (\'" +couponCode1+ "\',\'" +couponCode2+ "\',\'" +couponCode7+ "\',\'" +couponCode8+ "\',\'" +couponCode16+ "\')")
    * print coupon_code_status

    * def update_delivered_TS = db.updateRow("UPDATE FC_MERCHANT_COUPONS SET DELIVERED_TS = CURRENT_TIMESTAMP - 20 WHERE MERCHANT_COUPON_CODE IN (\'" +couponCode3+ "\',\'" +couponCode4+ "\',\'" +couponCode5+ "\',\'" +couponCode6+ "\',\'" +couponCode9+ "\',\'" +couponCode10+ "\',\'" +couponCode11+ "\',\'" +couponCode12+ "\',\'" +couponCode13+ "\',\'" +couponCode14+ "\',\'" +couponCode15+ "\',\'" +couponCode16+ "\')")
  ...
  Scenario: B2B_FLAT_DISCOUNT_ON_SKU redeem partial return flow __0036.1
    * def body  =
    ...
    When method post
    Then status 200
    * def coupon_code_status = db.readRows("SELECT * FROM FC_MERCHANT_COUPONS WHERE MERCHANT_COUPON_CODE IN (\'" +couponCode3+ "\',\'" +couponCode4+ "\',\'" +couponCode5+ "\',\'" +couponCode6+ "\',\'" +couponCode9+ "\',\'" +couponCode10+ "\',\'" +couponCode11+ "\',\'" +couponCode12+ "\',\'" +couponCode13+ "\',\'" +couponCode14+ "\',\'" +couponCode15+ "\')")
    * print coupon_code_status
