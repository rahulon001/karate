...
Feature: B2B_SKU_AT_FIXED_PRICE Bill_voucher mark redeem flow __0025.3
  ...
  Scenario: B2B_SKU_AT_FIXED_PRICE checkout mark redeem flow __0025.3
  ...
  Scenario: B2B_SKU_AT_FIXED_PRICE checkout mark redeem flow __0025.3
    ...
    * match response.discountAmount.toFixed(1) == (apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].discountAmount + discount_bill_voucher).toFixed(1)
    * match response.newBillAmount.toFixed(1) == (apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].newBillAmount - discount_bill_voucher).toFixed(1)

  Scenario: B2B_SKU_AT_FIXED_PRICE deliver mark redeem flow __0025.3
  ...
  Scenario: Switching off the features __0025.3.
