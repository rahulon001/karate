Feature: BxGy parent payment type return flow __0001.5
  ...
  Background:
    ...
    * json result = callonce read("B2C_B2B_CouponCodeGeneration.feature@BxGy_parent_cart_payment")
  ...
  Scenario: merchant verify b2c BxGy parent payment type __0001.5.
    * def body =
    """
      {
        "masId": "#(masid)",
        ...
        "tId": "xyzklj199",
        "billAmount": #(apiComponents["B2C_BxGy_parent_paymentType__0001.5"].billAmount),
        "couponCodes": "#(couponCode1)",
        "skuData": #(apiComponents["B2C_BxGy_parent_paymentType__0001.5"].skuData)
      }
    """
    ...
    When method post
    Then status 200
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_parent_paymentType_responseData__0001.5"].discountType1
    * match response.data[0].discount == apiComponents["B2C_BxGy_parent_paymentType_responseData__0001.5"].discount1
    * match response.discountedItems[0].skuId == apiComponents["B2C_BxGy_parent_paymentType_responseData__0001.5"].free_skuId1
    * match response.newBillAmount == apiComponents["B2C_BxGy_parent_paymentType_responseData__0001.5"].newBillAmount
  ...
  Scenario: merchant checkout b2c BxGy parent payment type __0001.5.
    * def body =
    """
      {
        "masId": "#(masid)",
...
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_parent_paymentType_responseData__0001.5"].discountType1
  ...
  Scenario: merchant accept-order b2c BxGy parent payment type __0001.5.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant delivered-order b2c BxGy parent payment type __0001.5.
    * def body =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant return-order b2c BxGy parent payment type __0001.5.
    * header x-client-type = "mpos"
    * def body  =
    """
    {
      "masId": "#(masid)",
      "discountedBillAmount": #(apiComponents["B2C_BxGy_parent_discountType_responseData__0001.5".newBillAmount]),
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_BxGy_parent_paymentType__0001.5"].skuData),
      "returnedItems": #(apiComponents["B2C_BxGy_parent_paymentType__0001.5"].skuData)
    }
    """
  ...
  Scenario: merchant order-returned b2c BxGy parent payment type __0001.5.
    * header x-client-type = "mpos"
    * def body =
    """
    {
