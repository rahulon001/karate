Feature: BxGy parent mark redeem flow __0007.1
  ...
  Background:
    ...
    * json result = callonce read("B2C_B2B_CouponCodeGeneration.feature@BxGy_percentage_parent_cart")
  ...
  Scenario: merchant verify b2c BxGy parent percentage off __0007.1.
    * def body =
    """
      {
        "masId": "#(masid)",
        ...
        "tId": "xyzklj199",
        "billAmount": #(apiComponents["B2C_BxGy_parent_percentage_off_discountType__0007"].billAmount),
        "couponCodes": "#(couponCode1)",
        "skuData": #(apiComponents["B2C_BxGy_parent_percentage_off_discountType__0007"].skuData)
      }
    """
    ...
    When method post
    Then status 200
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_parent_percentage_off_discountType_responseData__0007"].discountType1
    * match response.data[0].discount == apiComponents["B2C_BxGy_parent_percentage_off_discountType_responseData__0007"].discount1
    * match response.discountedItems[0].skuId == apiComponents["B2C_BxGy_parent_percentage_off_discountType_responseData__0007"].discountedItems_skuId1
    * match response.newBillAmount == apiComponents["B2C_BxGy_parent_percentage_off_discountType_responseData__0007"].newBillAmount
    * match response.data[0].appliedQuantity == apiComponents["B2C_BxGy_parent_percentage_off_discountType_responseData__0007"].appliedQuantity1
...
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_parent_percentage_off_discountType_responseData__0007"].discountType1
  ...
  Scenario: merchant accept-order b2c BxGy parent __0007.1.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant return-order b2c BxGy parent percentage payment type __0007.1.Partial return negative case
    ...
    * def body  =
    ...
    {
      "masId": "#(masid)",
      "discountedBillAmount": #(apiComponents["B2C_BxGy_parent_percentage_off_discountType_responseData__0007"].newBillAmount),
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_BxGy_parent_percentage_off_discountType__0007"].skuData),
      "returnedItems": #(apiComponents["B2C_BxGy_parent_percentage_off_discountType_return__0007"].skuData1)
    }
    """
  ...
  Scenario: merchant return-order b2c BxGy parent percentage payment type __0007.1.Partial return negative case
    ...
    * def body  =
    """
    {
      ...
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_BxGy_parent_percentage_off_discountType__0007"].skuData),
      "returnedItems": #(apiComponents["B2C_BxGy_parent_percentage_off_discountType_return__0007"].skuData2)
    }
    """
    Given path '/coupons/v1/coupons/merchant/return-order'
    And request body
  ...
  Scenario: merchant return-order b2c BxGy parent percentage payment type __0007.1.
    ...
    * def body  =
    """
    {
      ...
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_BxGy_parent_percentage_off_discountType__0007"].skuData),
      "returnedItems": #(apiComponents["B2C_BxGy_parent_percentage_off_discountType__0007"].skuData)
    }
    """
    Given path '/coupons/v1/coupons/merchant/return-order'
    And request body
