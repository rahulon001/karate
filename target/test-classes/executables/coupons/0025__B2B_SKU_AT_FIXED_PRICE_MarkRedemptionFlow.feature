@ignore
Feature: B2B_SKU_AT_FIXED_PRICE MarkRedemptionFlow __0025
  ...
  Scenario: B2B_SKU_AT_FIXED_PRICE checkout Mark Redemption Flow __0025.
  ...
  Scenario: B2B_SKU_AT_FIXED_PRICE checkout Mark Redemption Flow __0025.
      # redemption count
#    * def redeem_quantity_811143212226 = db.readRows("SELECT QUANTITY FROM B2B_COUPON_REDEMPTION WHERE B2B_COUPON_ID IN (SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212226+ "\'))")
#    * def redeem_quantity_811143212227 = db.readRows("SELECT QUANTITY FROM B2B_COUPON_REDEMPTION WHERE B2B_COUPON_ID IN (SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212227+ "\'))")
#    * def redeem_quantity_811143212228 = db.readRows("SELECT QUANTITY FROM B2B_COUPON_REDEMPTION WHERE B2B_COUPON_ID IN (SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212228+ "\'))")
 ...
 #   * def redeem_quantity_811143212226_c = db.readRows("SELECT QUANTITY FROM B2B_COUPON_REDEMPTION WHERE B2B_COUPON_ID IN (SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212226+ "\'))")
 #   * def redeem_quantity_811143212227_c = db.readRows("SELECT QUANTITY FROM B2B_COUPON_REDEMPTION WHERE B2B_COUPON_ID IN (SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212227+ "\'))")
 #   * def redeem_quantity_811143212228_c = db.readRows("SELECT QUANTITY FROM B2B_COUPON_REDEMPTION WHERE B2B_COUPON_ID IN (SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212228+ "\'))")
#
 #   # redemption count
 #    * match parseInt(redeem_quantity_811143212226_c[0].QUANTITY) == parseInt(redeem_quantity_811143212226[0].QUANTITY + 2)
 #   * match parseInt(redeem_quantity_811143212227_c[0].QUANTITY) == parseInt(redeem_quantity_811143212227[0].QUANTITY + 3)
 #   * match parseInt(redeem_quantity_811143212228_c[0].QUANTITY) == parseInt(redeem_quantity_811143212228[0].QUANTITY + 1)
  ...
  Scenario: B2B_SKU_AT_FIXED_PRICE delivered Mark Redemption Flow __0025.
  ...
  Scenario: B2B_SKU_AT_FIXED_PRICE redeem Mark Redemption Flow __0025.
    * def body  =
    """
    {
  ...
  Scenario: Switching off the features __0025.
  ...
  #  incase of data corruption
  #  UPDATE FC_MERCHANT_COUPONS SET STATUS = 'cancelled' WHERE  MASID = '100001000071385';
  #  commit origin