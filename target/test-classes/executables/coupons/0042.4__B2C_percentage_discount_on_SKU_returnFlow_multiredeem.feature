Feature: b2c percentage discount on sku discount type return flow multi redeem __0042.4
  ...
  Background:
    ...
    * def sku_price = apiComponents["B2C_percentage_discount_on_SKU_discountType_mrpc_responseData__0042.4"].price1
  ...
  Scenario: merchant verify b2c percentage discount on sku discount type __0042.4
    ...
    * def body =
    ...
    When method post
    Then status 200
    * match response.data[0].discountType == apiComponents["B2C_percentage_discount_on_SKU_discountType_mrpc_responseData__0042.4"].discountType1
    * match response.data[0].discount == apiComponents["B2C_percentage_discount_on_SKU_discountType_mrpc_responseData__0042.4"].discount1
    * match response.discountedItems[0].skuId == apiComponents["B2C_percentage_discount_on_SKU_discountType_mrpc_responseData__0042.4"].discountedItems_skuId1
    * match response.newBillAmount == apiComponents["B2C_percentage_discount_on_SKU_discountType_mrpc_responseData__0042.4"].newBillAmount
  ...
  Scenario: merchant return-order b2c b2c percentage discount on sku discount type __0042.4
    * header x-client-type = "mpos"
    * def body  =
    """
    {
      "masId": "#(masid)",
      "discountedBillAmount": #(apiComponents["B2C_percentage_discount_on_SKU_discountType_mrpc_responseData__0042.4"].newBillAmount),
  ...
  Scenario: merchant order-returned(cancel) b2c b2c percentage discount on sku discount type __0042.4
    * header x-client-type = "mpos"
    * def body =
    """
    {
