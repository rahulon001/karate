Feature: BxGy child payment type return flow __0002.9
  ...
  Background:
    ...
    * json result = callonce read("B2C_B2B_CouponCodeGeneration.feature@BxGy_child_cart_payment_BillCondition")
    * assert apiComponents["B2C_BxGy_child_paymentType__0002.9"].billAmount>=apiComponents["B2C_BxGy_child_paymentType_responseData__0002.9"].minbillCondition
  ...
  Scenario: merchant verify b2c BxGy child payment type __0002.9.
    * def body =
    """
      {
        "masId": "#(masid)",
        ...
        "tId": "xyzklj199",
        "billAmount": #(apiComponents["B2C_BxGy_child_paymentType__0002.9"].billAmount),
        "couponCodes": "#(couponCode1)",
        "skuData": #(apiComponents["B2C_BxGy_child_paymentType__0002.9"].skuData)
      }
    """
    ...
    When method post
    Then status 200
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_child_paymentType_responseData__0002.9"].discountType1
    * match response.data[0].discount == apiComponents["B2C_BxGy_child_paymentType_responseData__0002.9"].discount1
    * match response.discountedItems[0].skuId == apiComponents["B2C_BxGy_child_paymentType_responseData__0002.9"].free_skuId1
    * match response.newBillAmount == apiComponents["B2C_BxGy_child_paymentType_responseData__0002.9"].newBillAmount
  ...
  Scenario: merchant checkout b2c BxGy child payment type __0002.9.
    * def body =
    """
      {
        "masId": "#(masid)",
...
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_child_paymentType_responseData__0002.9"].discountType1
  ...
  Scenario: merchant accept-order b2c BxGy child payment type __0002.9.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant delivered-order b2c BxGy child payment type __0002.9.
    * def body =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant return-order b2c BxGy child payment type __0002.9.
    * header x-client-type = "mpos"
    * def body  =
    """
    {
      "masId": "#(masid)",
      "discountedBillAmount": #(apiComponents["B2C_BxGy_child_paymentType_responseData__0002.9"].newBillAmount),
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_BxGy_child_paymentType__0002.9"].skuData),
      "returnedItems": #(apiComponents["B2C_BxGy_child_paymentType__0002.9"].skuData)
    }
    """
  ...
  Scenario: merchant order-returned b2c BxGy child payment type __0002.9.
    * header x-client-type = "mpos"
    * def body =
    """
    {
