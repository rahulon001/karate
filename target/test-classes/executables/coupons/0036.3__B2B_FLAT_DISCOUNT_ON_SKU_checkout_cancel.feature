Feature: B2B_FLAT_DISCOUNT_ON_SKU partial return flow __0036.3
...
#
 ...
 #   * match parseInt(redeem_quantity_811143212222_c[0].QUANTITY) == parseInt(redeem_quantity_811143212222[0].QUANTITY + 2)
  ...
  Scenario: B2B_FLAT_DISCOUNT_ON_SKU delayed cancel checkoutCancel flow __0036.3
     # redemption count
    * def redeem_quantity_811143212221 = db.readRows("SELECT QUANTITY FROM B2B_COUPON_REDEMPTION WHERE B2B_COUPON_ID IN (SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212221+ "\')) and masid=\'" +masid+ "\'")
    * def redeem_quantity_811143212223 = db.readRows("SELECT QUANTITY FROM B2B_COUPON_REDEMPTION WHERE B2B_COUPON_ID IN (SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212223+ "\')) and masid=\'" +masid+ "\'")
    * def redeem_quantity_811143212222 = db.readRows("SELECT QUANTITY FROM B2B_COUPON_REDEMPTION WHERE B2B_COUPON_ID IN (SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212222+ "\')) and masid=\'" +masid+ "\'")
    ...
    * assert parseInt(redeem_quantity_811143212221_r[0].QUANTITY) == parseInt(redeem_quantity_811143212221[0].QUANTITY - 1)
    * assert parseInt(redeem_quantity_811143212222_r[0].QUANTITY) == parseInt(redeem_quantity_811143212222[0].QUANTITY - 2)
    * assert parseInt(redeem_quantity_811143212223_r[0].QUANTITY) == parseInt(redeem_quantity_811143212223[0].QUANTITY - 3)

    * assert parseInt(redeem_count_811143212221_r[0].REDEEM_COUNT) == parseInt(redeem_count_811143212221[0].REDEEM_COUNT - 1)
    * assert parseInt(redeem_count_811143212222_r[0].REDEEM_COUNT) == parseInt(redeem_count_811143212222[0].REDEEM_COUNT - 2)
    * assert parseInt(redeem_count_811143212223_r[0].REDEEM_COUNT) == parseInt(redeem_count_811143212223[0].REDEEM_COUNT - 3)
