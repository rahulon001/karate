Feature: B2C flat discount on SKU B2B mark redeem flow  __0041.3
  ...
  Background:
    ...
    * def result = callonce read("B2C_B2B_CouponCodeGeneration.feature@B2B_flat_discount_on_SKU_redemption") {requestHeader: #(headerJson)}
  ...
  Scenario: B2B coupon code checkout __0041.3
  ...
  Scenario: B2B coupon code deliver __0041.3.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: B2B coupon code delayed cancel __0041.3.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
