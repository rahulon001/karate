...
#    * match skuID.indexOf("711143212228") == -1
  ...
  Scenario: B2B_PERCENT_DISCOUNT checkout partial return flow __0029.6
    ...
    * assert response.discountAmount == apiComponents["B2B_PERCENT_DISCOUNT_coupon_redemption_responseData__0029"].discountAmount_mbv_off
    * assert response.newBillAmount == apiComponents["B2B_PERCENT_DISCOUNT_coupon_redemption_responseData__0029"].newBillAmount_mbv_off
