Feature: BxGy_parent_percentage_off_mark_redeem_flow_discount_type __0007
  ...
  Scenario: merchant verify b2c BxGy parent percentage off __0007.
    * def body =
    """
      {
        "masId": "#(masid)",
...
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_parent_percentage_off_discountType_responseData__0007"].discountType1
  ...
  Scenario: merchant checkout b2c BxGy parent percentage off__0007.
    * def body =
    """
      {
        "masId": "#(masid)",
...
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_parent_percentage_off_discountType_responseData__0007"].discountType1
  ...
  Scenario: merchant accept-order b2c BxGy parent percentage off__0007.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant delivered-order b2c BxGy parent percentage off__0007.
    * def body =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant mark redeem b2c BxGy parent percentage off__0007.
    * def body  =
    """
    {
