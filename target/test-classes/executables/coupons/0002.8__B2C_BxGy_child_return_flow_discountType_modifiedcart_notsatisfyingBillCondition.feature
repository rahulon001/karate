Feature: BxGy child return order flow __0002.8
  ...
  Background:
    ...
    * json result = callonce read("B2C_B2B_CouponCodeGeneration.feature@BxGy_child_cart_BillCondition")
 ...
 #   * def discountAmount = apiComponents['B2C_BxGy_parent_discountType___0002.6']['discountAmount']
 #   * def newBillAmount = apiComponents['B2C_BxGy_child_discountType_responseData__0002.6']['newBillAmount']


  Scenario: merchant verify b2c BxGy child __0002.8.
    * def body =
    """
      {
        "masId": "#(masid)",
        ...
        "tId": "xyzklj199",
        "billAmount": #(apiComponents["B2C_BxGy_child_discountType__0002.6"].billAmount),
        "couponCodes": "#(couponCode1)",
        "skuData": #(apiComponents["B2C_BxGy_child_discountType__0002.6"].skuData)
      }
    """
    ...
    When method post
    Then status 200
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_child_discountType_responseData__0002.6"].discountType1
    * match response.data[0].discount == apiComponents["B2C_BxGy_child_discountType_responseData__0002.6"].discount1
    * match response.discountedItems[0].skuId == apiComponents["B2C_BxGy_child_discountType_responseData__0002.6"].discountedItems_skuId1
    * match response.newBillAmount == apiComponents["B2C_BxGy_child_discountType_responseData__0002.6"].newBillAmount
  ...
  Scenario: merchant checkout b2c BxGy child __0002.8.
    * def body =
    """
      {
        "masId": "#(masid)",
...
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_child_discountType_responseData__0002.6"].discountType1
  ...
  Scenario: merchant accept-order b2c BxGy child __0002.8.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant delivered-order b2c BxGy child __0002.8.
    * def body =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant return-order non-coupon item b2c BxGy child __0002.8.
    * header x-client-type = "mpos"
    * def body  =
    """
    {
      "masId": "#(masid)",
      "discountedBillAmount": #(apiComponents["B2C_BxGy_child_discountType_responseData__0002.6"].newBillAmount),
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_BxGy_child_discountType__0002.6"].skuData),
      "returnedItems": [{
          "skuId": "1009988858",
          "skuQty": 3,
          "skuPrice": 60
  ...
  Scenario: merchant return-order b2c BxGy child __0002.8.
    * header x-client-type = "mpos"
    * def body  =
    """
    {
      ...
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_BxGy_child_discountType__0002.6"].skuData),
      "returnedItems": #(apiComponents["B2C_BxGy_child_discountType__0002.6"].skuData)
    }
    """
    Given path '/coupons/v1/coupons/merchant/return-order'
    And request body
...
#    * call sleep 30
  ...
  Scenario: merchant order-returned b2c BxGy child __0002.8.
    * header x-client-type = "mpos"
    * def body =
    """
    {
