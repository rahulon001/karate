Feature: BxGy B2B mark redeem flow child __0002.10
  ...
  Background:
    ...
    * def b2b_coupon_redemption = callonce read("0002.6__B2C_BxGy_child_mark_redeem_flow_discountType_BillCondition_Satisfied.feature@bxgy_child_BillCondition")
    * json result = callonce read("B2C_B2B_CouponCodeGeneration.feature@B2B_BxGy_child_cart_redemption_BillCondition") {requestHeader: #(headerJson)}
  ...
  Scenario: B2B coupon code checkout __0002.10.
    * header override_flag = redeem_flags
    * def body =
    """
        {
          "masId": "#(masid)",
          "billAmount": #(apiComponents["B2B_BxGy_child_discountType__0002.10"].billAmount),
          "transactionId": "#(transaction_id)",
          "couponCodes": [#(couponCode1)],
          "skuData": #(apiComponents["B2B_BxGy_child_discountType__0002.10"].skuData)
        }
    """
    ...
    When method post
    Then status 200
    And match response.discountAmount == apiComponents["B2B_BxGy_child_responseData__0002.10"].discountAmount
    And match response.newBillAmount == apiComponents["B2B_BxGy_child_responseData__0002.10"].newBillAmount
  ...
  Scenario: B2B coupon code deliver __0002.10
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: B2B coupon code delayed cancel __0002.10.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
