Feature: BxGy child percentage return flow multi redeem __0008.4
  ...
  Background:
    ...
    * def sku_price1 = apiComponents["B2C_BxGy_child_percentage_off_discountType_responseData_mrpc__0008.4"].maxPrice
    * def sku_price2 = apiComponents["B2C_BxGy_child_percentage_off_discountType_responseData_mrpc__0008.4"].maxPrice
    ...
    * json result = callonce read("B2C_B2B_CouponCodeGeneration.feature@BxGy_child_percentage_cart_mrpc") {skuPrice1: #(sku_price1),skuPrice2: #(sku_price2), billAmount: #(bill_amount), body: #(body)}
  ...
  Scenario: merchant verify b2c BxGy child percentage  __0008.4
    ...
    * def body =
    """
    {
      ...
      "tId": "xyzklj199",
      "billAmount": #(apiComponents["B2C_BxGy_child_percentage_off_discountType_mrpc__0008.4"].billAmount),
      ...
      "couponsApplied": [
        ...
        "skuData": #(apiComponents["B2C_BxGy_child_percentage_off_discountType_mrpc__0008.4"].skuData)
    }
    """
    ...
    * match response.newBillAmount.toFixed(2) == (apiComponents["B2C_BxGy_child_percentage_off_discountType_mrpc__0008.4"].billAmount - coupon_discount_customer).toFixed(2)
  ...
  Scenario: merchant checkout b2c BxGy child percentage  __0008.4
    * header x-client-type = "mpos"
    * def body =
    """
    {
    ...
    """
    * set body.skuData[*].skuPrice = sku_price1
    ...
    * assert merchant_sku[0].SKU == disc_SKU[0].SKU

  Scenario: merchant accept-order b2c BxGy child percentage  __0008.4
 ...
 #   * assert redeem_count_a[0].REDEEM_COUNT == redeem_count[0].REDEEM_COUNT + coupon_redeem
  ...
  Scenario: merchant delivered-order b2c BxGy child percentage  __0008.4
    * header x-client-type = "mpos"
    * def body  =
    """
    {
  ...
  Scenario: merchant return-order b2c BxGy child percentage  __0008.4
    * def discounted_billAmount = (apiComponents["B2C_BxGy_child_percentage_off_discountType_mrpc__0008.4"].billAmount - coupon_discount_customer).toFixed(2)
    ...
    * def body  =
    ...
    {
      "masId": "#(masid)",
      "discountedBillAmount": #(apiComponents["B2C_BxGy_child_percentage_off_discountType_mrpc__0008.4"].newBillAmount),
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_BxGy_child_percentage_off_discountType_mrpc__0008.4"].skuData),
      "returnedItems": #(apiComponents["B2C_BxGy_child_percentage_off_discountType_mrpc__0008.4"].skuData)
    }
    """
  ...
  Scenario: merchant order-returned(cancel) b2c BxGy child percentage  __0008.4
