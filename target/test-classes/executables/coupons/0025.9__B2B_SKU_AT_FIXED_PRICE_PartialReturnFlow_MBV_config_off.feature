Feature: B2B_SKU_AT_FIXED_PRICE partial return flow __0025.6
  ...
  Background:
    ...
    * def bill_amount = apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].billAmount_mbv
 ...
 #   * match skuID.indexOf("811143212228") == -1
  ...
  Scenario: B2B_SKU_AT_FIXED_PRICE checkout partial return flow __0025.6.
    ...
    * def b2b_coupons = db.readRows("SELECT * FROM B2B_COUPON WHERE ID IN (\'" +coupon_code_status[0]["B2B_COUPON_ID"]+ "\',\'" +coupon_code_status[1]["B2B_COUPON_ID"]+ "\',\'" +coupon_code_status[2]["B2B_COUPON_ID"]+ "\',\'" +coupon_code_status[3]["B2B_COUPON_ID"]+ "\',\'" +coupon_code_status[4]["B2B_COUPON_ID"]+ "\',\'" +coupon_code_status[5]["B2B_COUPON_ID"]+ "\')")
    * print b2b_coupons
    * def b2b_coupon_redemption = db.readRows("SELECT * FROM B2B_COUPON_REDEMPTION WHERE B2B_COUPON_ID IN (\'" +coupon_code_status[0]["B2B_COUPON_ID"]+ "\',\'" +coupon_code_status[1]["B2B_COUPON_ID"]+ "\',\'" +coupon_code_status[2]["B2B_COUPON_ID"]+ "\',\'" +coupon_code_status[3]["B2B_COUPON_ID"]+ "\',\'" +coupon_code_status[4]["B2B_COUPON_ID"]+ "\',\'" +coupon_code_status[5]["B2B_COUPON_ID"]+ "\')")
  ...
  Scenario: B2B_SKU_AT_FIXED_PRICE checkout partial return flow __0025.6.
    ...
    * def body =
    """
      {
      "masId": "#(masid)",
      "billAmount": #(apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].billAmount_mbv),
    ...
    * match response.discountAmount == apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].discountAmount_mbv_off
    * match response.newBillAmount == apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].newBillAmount_mbv_off
    ...
    * match response.data[coupon_code.indexOf(couponCode1)].discount.toFixed(1) contains apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].discount_811143212226.toFixed(1)
    * match response.data[coupon_code.indexOf(couponCode2)].discount.toFixed(1) contains apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].discount_811143212226.toFixed(1)
    * match response.data[coupon_code.indexOf(couponCode3)].discount.toFixed(1) contains apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].discount_811143212228.toFixed(1)
    * match response.data[coupon_code.indexOf(couponCode4)].discount.toFixed(1) contains apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].discount_811143212227.toFixed(1)
    * match response.data[coupon_code.indexOf(couponCode5)].discount.toFixed(1) contains apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].discount_811143212227.toFixed(1)
    * match response.data[coupon_code.indexOf(couponCode6)].discount.toFixed(1) contains apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].discount_811143212227.toFixed(1)
