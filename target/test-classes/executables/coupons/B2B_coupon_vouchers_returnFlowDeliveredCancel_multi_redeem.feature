@ignore
Feature: Perform B2B return multi-redeem flow voucher
  ...
  Scenario: merchant redeem B2BCancleCoupon.
    ...
    * def coupon_code_status = db.readRows("SELECT * FROM B2BCOUPONMAPPING bb WHERE COUPONCODE IN (\'" +couponCode1+ "\',\'" +couponCode2+ "\',\'" +couponCode3+ "\',\'" +couponCode4+ "\',\'" +couponCode5+ "\')")
    * print coupon_code_status
    * def COUPONCODE_status = db.readRows("SELECT * FROM B2BCOUPONMAPPING WHERE COUPONCODE IN (\'" +couponCode1+ "\',\'" +couponCode2+ "\',\'" +couponCode3+ "\',\'" +couponCode4+ "\',\'" +couponCode5+ "\',\'" +VoucherCode1+ "\')")
    * print COUPONCODE_status
