Feature: B2B_PERCENT_DISCOUNT partial return flow __0029.1
  ...
  Background:
    ...
    * def bill_amount = apiComponents["B2B_PERCENT_DISCOUNT_coupon_redemption__0029.10"].billAmount
    ...
    * assert result.response["skuCoupons"][skuID_index_711143212229]["coupons"][0]["discountType"] == apiComponents["B2B_PERCENT_DISCOUNT_coupon_redemption_responseData__0029.10"].discountType
    * assert result.response["skuCoupons"][skuID_index_711143212229]["coupons"][1]["discountType"] == apiComponents["B2B_PERCENT_DISCOUNT_coupon_redemption_responseData__0029.10"].discountType
    * assert result.response["skuCoupons"][skuID_index_711143212230]["coupons"][0]["discountType"] == apiComponents["B2B_PERCENT_DISCOUNT_coupon_redemption_responseData__0029.10"].discountType
    * assert result.response["skuCoupons"][skuID_index_711143212230]["coupons"][1]["discountType"] == apiComponents["B2B_PERCENT_DISCOUNT_coupon_redemption_responseData__0029.10"].discountType
  ...
  Scenario: B2B_PERCENT_DISCOUNT verify hold status __0029.1
  ...
  Scenario: B2B_PERCENT_DISCOUNT checkout partial return flow __0029.1
    ...
    * assert response.discountAmount == apiComponents["B2B_PERCENT_DISCOUNT_coupon_redemption_responseData__0029.10"].discountAmount
    * assert response.newBillAmount == apiComponents["B2B_PERCENT_DISCOUNT_coupon_redemption_responseData__0029.10"].newBillAmount
#    * match each response.data[*].discountType == apiComponents["B2B_PERCENT_DISCOUNT_coupon_redemption_responseData__0029.10"].discountType
  ...
  Scenario: B2B_PERCENT_DISCOUNT delivered partial return flow __0029.1
  ...
  Scenario: B2B_PERCENT_DISCOUNT delayed cancel partial return flow __0029.1
    * def body  =
    """
    {
  ...
  Scenario: B2B_PERCENT_DISCOUNT redeem partial return flow __0029.1
    * def body  =
    """
    {
    }
  ...
  Scenario: B2B_PERCENT_DISCOUNT checkout of cancelled coupons in partial return flow __0029.1
    * def body =
    """
      {
      "masId": "#(masid)",
