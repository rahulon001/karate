Feature: B2C flat discount on sku return flow discount type__0041.8
  ...
  Background:
    ...
    * def result = callonce read("B2C_B2B_CouponCodeGeneration.feature@B2C_flat_discount_on_SKU_BillCondition")
  ...
  Scenario: merchant verify b2c B2C flat discount on sku __0041.8.
    * def body =
    """
      {
        "masId": "#(masid)",
        ...
        "tId": "xyzklj199",
        "billAmount": #(apiComponents["B2C_flat_discount_on_SKU_discountType__0041.6"].billAmount),
        "couponCodes": "#(couponCode1)",
        "skuData": #(apiComponents["B2C_flat_discount_on_SKU_discountType__0041.6"].skuData)
      }
    """
    ...
    When method post
    Then status 200
    * match response.data[0].discountType == apiComponents["B2C_flat_discount_on_SKU_discountType_responseData__0041.6"].discountType1
    * match response.data[0].discount == apiComponents["B2C_flat_discount_on_SKU_discountType_responseData__0041.6"].discount1
    * match response.discountedItems[0].skuId == apiComponents["B2C_flat_discount_on_SKU_discountType_responseData__0041.6"].skuId1
    * match response.newBillAmount == apiComponents["B2C_flat_discount_on_SKU_discountType_responseData__0041.6"].newBillAmount
  ...
  Scenario: merchant checkout b2c B2C flat discount on sku __0041.8
    * def body =
    """
      {
        "masId": "#(masid)",
  ...
  Scenario: merchant accept-order b2c B2C flat discount on sku __0041.8.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant delivered-order b2c B2C flat discount on sku __0041.8.
    * def body =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant return-order non-coupon item b2c B2C flat discount on sku __0041.8.
    * header x-client-type = "mpos"
   * def body  =
    """
    {
      "masId": "#(masid)",
      "discountedBillAmount": #(apiComponents["B2C_flat_discount_on_SKU_discountType_responseData__0041.6"].newBillAmount),
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_flat_discount_on_SKU_discountType__0041.6"].skuData),
      "returnedItems": [{
          "skuId": "1009988854",
          "skuQty": 2,
          "skuPrice": 80
  ...
  Scenario: merchant return-order item b2c B2C flat discount on sku __0041.8.
    * header x-client-type = "mpos"
    * def body  =
    """
    {
      ...
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_flat_discount_on_SKU_discountType__0041.6"].skuData),
      "returnedItems": #(apiComponents["B2C_flat_discount_on_SKU_discountType__0041.6"].skuData)
    }
    """
    Given path '/coupons/v1/coupons/merchant/return-order'
    And request body
...
#    * call sleep 30
  ...
  Scenario: merchant order-returned b2c B2C flat discount on sku __0041.8.
    * header x-client-type = "mpos"
    * def body =
    """
    {
