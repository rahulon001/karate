...
#Redeem count After checkout & accept
  ...
  Scenario: merchant return-order b2c flat discount on SKU __0041.12 Return partial. modified cart not satisfying MBV
    ...
    * def body  =
    ...
    {
      "masId": "#(masid)",
      "discountedBillAmount": #(apiComponents["B2C_flat_discount_on_SKU_discountType_responseData__0041.12"].newBillAmount),
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_flat_discount_on_SKU_discountType__0041.12"].skuData),
      "returnedItems": #(apiComponents["B2C_flat_discount_on_SKU_discountType_return__0041.12"].skuData1)
    }
    """
  ...
  Scenario: merchant return-order b2c flat discount on SKU __0041.12 Return partial. modified cart not satisfying MBV
    ...
    * def body  =
    """
    {
      ...
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_flat_discount_on_SKU_discountType__0041.12"].skuData),
      "returnedItems": #(apiComponents["B2C_flat_discount_on_SKU_discountType_return__0041.12"].skuData2)
    }
    """
    Given path '/coupons/v1/coupons/merchant/return-order'
    And request body
  ...
  Scenario: merchant return-order b2c flat discount on SKU __0041.12 Return partial. modified cart  satisfying MBV
    ...
    * def body  =
    """
    {
      ...
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_flat_discount_on_SKU_discountType__0041.12"].skuData),
      "returnedItems": #(apiComponents["B2C_flat_discount_on_SKU_discountType_return__0041.12"].skuData3)
    }
    """
    Given path '/coupons/v1/coupons/merchant/return-order'
    And request body
...
#      "couponCodesApplied":[#(couponCode1)],
#      "originalCart": #(apiComponents["B2C_flat_discount_on_SKU_discountType__0041.12"].skuData),
#      "returnedItems": #(apiComponents["B2C_flat_discount_on_SKU_discountType_return__0041.12"].skuData4)
#    }
#    """
#    Given path '/coupons/v1/coupons/merchant/return-order'
#    And request body
...
#    Then status 400
  ...
  Scenario: merchant return-order b2c flat discount on SKU __0041.12
    * header x-client-type = "mpos"
    * def body  =
    """
    {
      ...
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_flat_discount_on_SKU_discountType__0041.12"].skuData),
      "returnedItems": #(apiComponents["B2C_flat_discount_on_SKU_discountType__0041.12"].skuData)
    }
    """
    Given path '/coupons/v1/coupons/merchant/return-order'
    And request body
...
#    * call sleep 30
  ...
  Scenario: merchant order-returned b2c flat discount on SKU __0041.12.
