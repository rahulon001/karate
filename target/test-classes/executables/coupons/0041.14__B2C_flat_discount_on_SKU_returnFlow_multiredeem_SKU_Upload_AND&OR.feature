Feature: B2C flat discount on SKU return flow multi redeem __0041.4
  ...
  Background:
    ...
    * def sku_data1 = apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc_responseData__0041.14"].skuData1
    ...
    * def sku_data2 = apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc_responseData__0041.14"].skuData2
    ...
    * match result.response["skuCoupons"] == []
    * def sku_data3 = apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc_responseData__0041.14"].skuData3
    ...
    * def discount2 = result.response["skuCoupons"][skuID_index_1009977757]["coupons"][0]["discount"]
    * def discount3 = result.response["skuCoupons"][skuID_index_1009977758]["coupons"][0]["discount"]
    
    * match discount1 == apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc_responseData__0041.14"].discount1
    * match discount2 == apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc_responseData__0041.14"].discount1
    * match discount3 == apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc_responseData__0041.14"].discount1
  ...
  Scenario: merchant verify b2c B2C flat discount on SKU __0041.4
    ...
    * def body =
    """
    {
      ...
      "tId": "xyzklj199",
      "billAmount": #(apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc__0041.14"].billAmount),
      ...
      "couponsApplied": [
        ...
        "skuData": #(apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc__0041.14"].skuData)
    }
    """
    ...
    When method post
    Then status 200
    * match response.data[0].discountType == apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc_responseData__0041.14"].discountType1
    * match response.data[0].discount == apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc_responseData__0041.14"].discount1
    * match response.discountedItems[0].skuId == apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc_responseData__0041.14"].discountedItems_skuId1
    * match response.discountedItems[1].skuId == apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc_responseData__0041.14"].discountedItems_skuId2
    * match response.discountedItems[2].skuId == apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc_responseData__0041.14"].discountedItems_skuId3
    * match response.newBillAmount == apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc_responseData__0041.14"].newBillAmount
  ...
  Scenario: merchant return-order b2c B2C flat discount on SKU __0041.4.Return partial. modified cart not satisfying MBV
    * header x-client-type = "mpos"
    * def body  =
    """
    {
      "masId": "#(masid)",
      "discountedBillAmount": #(apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc_responseData__0041.14"].newBillAmount),
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc__0041.14"].skuData),
      "returnedItems": #(apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc_return__0041.14"].skuData1)
    }
    """
  ...
  Scenario: merchant return-order b2c B2C flat discount on SKU __0041.4.Return partial. modified cart not satisfying MBV
    ...
    * def body  =
    """
    {
      ...
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc__0041.14"].skuData),
      "returnedItems": #(apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc_return__0041.14"].skuData2)
    }
    """
    Given path '/coupons/v1/coupons/merchant/return-order'
    And request body
  ...
  Scenario: merchant return-order b2c B2C flat discount on SKU __0041.4.Return partial. modified cart not satisfying MBV
    ...
    * def body  =
    """
    {
      ...
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc__0041.14"].skuData),
      "returnedItems": #(apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc_return__0041.14"].skuData3)
    }
    """
    Given path '/coupons/v1/coupons/merchant/return-order'
    And request body
...
#      "couponCodesApplied":[#(couponCode1)],
#      "originalCart": #(apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc__0041.14"].skuData),
#      "returnedItems": #(apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc_return__0041.14"].skuData4)
#    }
#    """
#    Given path '/coupons/v1/coupons/merchant/return-order'
#    And request body
  ...
  Scenario: merchant return-order b2c B2C flat discount on SKU __0041.4
    ...
    * def body  =
    """
    {
      ...
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc__0041.14"].skuData),
      "returnedItems": #(apiComponents["B2C_flat_discount_on_SKU_discountType_mrpc__0041.14"].skuData)
    }
    """
    Given path '/coupons/v1/coupons/merchant/return-order'
    And request body
