...
Feature: B2B_FLAT_DISCOUNT_ON_SKU Bill_voucher mark redeem flow __0036.2
  ...
  Background:
    ...
    * def coupon_count_811143212221 = result.response.skuCoupons[skuID_index_811143212221].coupons.length
    * def coupon_count_811143212222 = result.response.skuCoupons[skuID_index_811143212222].coupons.length
    * def coupon_count_811143212223 = result.response.skuCoupons[skuID_index_811143212223].coupons.length
    * def voucher_count = result.response.billVouchers.length

    * def couponQuantity1 = coupon_count_811143212221
    * def couponQuantity2 = coupon_count_811143212222
    * def couponQuantity3 = coupon_count_811143212223
  ...
  Scenario: B2B_FLAT_DISCOUNT_ON_SKU checkout mark redeem flow __0036.2
 ...
 #   * def redeem_quantity_811143212222 = db.readRows("SELECT QUANTITY FROM B2B_COUPON_REDEMPTION WHERE B2B_COUPON_ID IN (SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212222+ "\'))")
    ...
    * assert response.discountAmount.toFixed(2) == (apiComponents["B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption_responseData__0036"].discountAmount + discount_bill_voucher).toFixed(2)
    * assert response.newBillAmount.toFixed(2) == (apiComponents["B2B_FLAT_DISCOUNT_ON_SKU_coupon_redemption_responseData__0036"].newBillAmount - discount_bill_voucher).toFixed(2)

  Scenario: B2B_FLAT_DISCOUNT_ON_SKU deliver mark redeem flow __0036.2
  ...
  Scenario: B2B_FLAT_DISCOUNT_ON_SKU mark redeem flow __0036.2
    * def body  =
    """
    {
