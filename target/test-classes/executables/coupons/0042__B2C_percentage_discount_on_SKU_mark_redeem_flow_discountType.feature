Feature: b2c percentage discount on sku mark redeem flow __0042
  ...
  Scenario: merchant verify b2c percentage discount on sku __0042.
    * def body =
    """
      {
        "masId": "#(masid)",
  ...
  Scenario: merchant checkout b2c percentage discount on sku __0042.
    * def body =
    """
      {
        "masId": "#(masid)",
  ...
  Scenario: merchant accept-order b2c percentage discount on sku __0042.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant delivered-order b2c percentage discount on sku __0042.
    * def body =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant mark redeem b2c percentage discount on sku __0042.
    * def body  =
    """
    {
