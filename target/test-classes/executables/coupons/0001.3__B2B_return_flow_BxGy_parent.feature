Feature: BxGy B2B mark redeem flow parent __0001.3
  ...
  Background:
    ...
    * def b2b_coupon_redemption = callonce read("0001__B2C_BxGy_parent_mark_redeem_flow_discountType.feature")
  ...
  Scenario: B2B coupon code geteligible__0001.3
  ...
  Scenario: B2B coupon code checkout __0001.3
   ...
   Scenario: B2B coupon code deliver __0001.3.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: B2B coupon code delayed cancel __0001.3.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
