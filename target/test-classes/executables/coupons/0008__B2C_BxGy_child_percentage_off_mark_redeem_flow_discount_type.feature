Feature: BxGy_child_percentage_off_mark_redeem_flow_discount_type __0008
  ...
  Scenario: merchant verify b2c BxGy child percentage off __0008.
    * def body =
    """
      {
        "masId": "#(masid)",
...
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_child_percentage_off_discountType_responseData__0008"].discountType1
  ...
  Scenario: merchant checkout b2c BxGy child percentage off__0008.
    * def body =
    """
      {
        "masId": "#(masid)",
...
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_child_percentage_off_discountType_responseData__0008"].discountType1
  ...
  Scenario: merchant accept-order b2c BxGy child percentage off__0008.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant delivered-order b2c BxGy child percentage off__0008.
    * def body =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant mark redeem b2c BxGy child percentage off__0008.
    * def body  =
    """
    {
