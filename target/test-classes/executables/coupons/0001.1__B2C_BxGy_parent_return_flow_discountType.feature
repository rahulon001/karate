Feature: BxGy parent return flow discount type__0001.1
  ...
  Background:
    ...
    * json result = callonce read("B2C_B2B_CouponCodeGeneration.feature@BxGy_parent_cart")
  ...
  Scenario: merchant verify b2c BxGy parent __0001.1.
    * def body =
    """
      {
        "masId": "#(masid)",
        ...
        "tId": "xyzklj199",
        "billAmount": #(apiComponents["B2C_BxGy_parent_discountType__0001"].billAmount),
        "couponCodes": "#(couponCode1)",
        "skuData": #(apiComponents["B2C_BxGy_parent_discountType__0001"].skuData)
      }
    """
...
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_parent_discountType_responseData__0001"].discountType1
    * match response.data[0].discount == apiComponents["B2C_BxGy_parent_discountType_responseData__0001"].discount1
    * match response.discountedItems[0].skuId == apiComponents["B2C_BxGy_parent_discountType_responseData__0001"].free_skuId1
    * match response.newBillAmount == apiComponents["B2C_BxGy_parent_discountType_responseData__0001"].newBillAmount
  ...
  Scenario: merchant checkout b2c BxGy parent __0001.1.
    * def body =
    """
      {
        "masId": "#(masid)",
...
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_parent_discountType_responseData__0001"].discountType1
  ...
  Scenario: merchant accept-order b2c BxGy parent __0001.1.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant delivered-order b2c BxGy parent __0001.1.
    * def body =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant return-order b2c BxGy parent __0001.1.- Return partial buy and get items- negative case
    * header x-client-type = "mpos"
    * def body  =
    """
    {
      "masId": "#(masid)",
      "discountedBillAmount": #(apiComponents["B2C_BxGy_parent_discountType_responseData__0001".newBillAmount]),
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_BxGy_parent_discountType__0001"].skuData),
      "returnedItems": #(apiComponents["B2C_BxGy_parent_discountType_return__0001"].skuData1)
    }
    """
  ...
  Scenario: merchant return-order b2c BxGy parent __0001.1.Return only buy items- negative case
    * header x-client-type = "mpos"
    * def body  =
    """
    {
      ...
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_BxGy_parent_discountType__0001"].skuData),
      "returnedItems": #(apiComponents["B2C_BxGy_parent_discountType_return__0001"].skuData2)
    }
    """
    Given path '/coupons/v1/coupons/merchant/return-order'
    And request body
  ...
  Scenario: merchant return-order b2c BxGy parent __0001.1.
    * header x-client-type = "mpos"
    * def body  =
    """
    {
      ...
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_BxGy_parent_discountType__0001"].skuData),
      "returnedItems": #(apiComponents["B2C_BxGy_parent_discountType__0001"].skuData)
    }
    """
    Given path '/coupons/v1/coupons/merchant/return-order'
    And request body
