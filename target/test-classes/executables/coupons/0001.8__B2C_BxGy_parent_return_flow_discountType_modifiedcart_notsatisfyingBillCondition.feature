Feature: BxGy parent return flow discount type__0001.8
  ...
  Background:
    ...
    * json result = callonce read("B2C_B2B_CouponCodeGeneration.feature@BxGy_parent_cart_BillCondition")
  ...
  Scenario: merchant verify b2c BxGy parent __0001.8.
    * def body =
    """
      {
        "masId": "#(masid)",
...
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_parent_discountType_responseData__0001"].discountType1
  ...
  Scenario: merchant accept-order b2c BxGy parent __0001.8.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant delivered-order b2c BxGy parent __0001.8.
    * def body =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant return-order non-coupon item b2c BxGy parent __0001.8.
    * header x-client-type = "mpos"
    * def body  =
    """
          {
            "masId": "#(masid)",
            "discountedBillAmount": #(apiComponents["B2C_BxGy_parent_discountType_responseData__0001.6"].newBillAmount),
            "couponCodesApplied":[#(couponCode1)],
            "originalCart": #(apiComponents["B2C_BxGy_parent_discountType__0001.6"].skuData),
            "returnedItems":[{
                "skuId": "1009988856",
                "skuQty": 2,
                "skuPrice": 80
  ...
  Scenario: merchant return-order item b2c BxGy parent __0001.8.
    * header x-client-type = "mpos"
    * def body  =
    """
    {
      ...
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_BxGy_parent_discountType__0001.6"].skuData),
      "returnedItems": #(apiComponents["B2C_BxGy_parent_discountType__0001.6"].skuData)
    }
    """
    Given path '/coupons/v1/coupons/merchant/return-order'
    And request body
...
#    * call sleep 30
  ...
  Scenario: merchant order-returned b2c BxGy parent __0001.8.
    * header x-client-type = "mpos"
    * def body =
    """
    {
