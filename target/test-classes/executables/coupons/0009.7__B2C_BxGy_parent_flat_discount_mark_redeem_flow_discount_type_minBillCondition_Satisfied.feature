Feature: BxGy_parent_percentage_off_mark_redeem_flow_discount_type __0009.7
  ...
  Background:
    ...
    * def bill_Amount = apiComponents["B2C_BxGy_parent_flat_off_discountType__0009.7"].billAmount
    * json result = callonce read("B2C_B2B_CouponCodeGeneration.feature@BxGy_flat_parent_cart_BillCondition")
    * assert bill_Amount>=apiComponents["B2C_BxGy_parent_flat_off_discountType_responseData__0009.7"].minbillCondition
  ...
  Scenario: merchant verify b2c BxGy parent percentage off __0009.7.
    * def body =
    """
      {
        "masId": "#(masid)",
...
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_parent_flat_off_discountType_responseData__0009.7"].discountType1
  ...
  Scenario: merchant checkout b2c BxGy parent percentage off__0009.7.
    * def body =
    """
      {
        "masId": "#(masid)",
...
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_parent_flat_off_discountType_responseData__0009.7"].discountType1
  ...
  Scenario: merchant accept-order b2c BxGy parent percentage off__0009.7.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant delivered-order b2c BxGy parent percentage off__0009.7.
    * def body =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant mark redeem b2c BxGy parent percentage off__0009.7.
    * def body  =
    """
    {
