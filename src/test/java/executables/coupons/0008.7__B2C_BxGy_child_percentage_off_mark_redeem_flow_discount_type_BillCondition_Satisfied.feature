Feature: BxGy_child_percentage_off_mark_redeem_flow_discount_type __0008.7
  ...
  Background:
    ...
    * def bill_Amount = apiComponents["B2C_BxGy_child_percentage_off_discountType__0008.7"].billAmount
  ...
  Scenario: merchant verify b2c BxGy child percentage off __0008.7.
    * def body =
    """
      {
        "masId": "#(masid)",
  ...
  Scenario: merchant checkout b2c BxGy child percentage off__0008.7.
    * def body =
    """
      {
        "masId": "#(masid)",
  ...
  Scenario: merchant accept-order b2c BxGy child percentage off__0008.7.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant delivered-order b2c BxGy child percentage off__0008.7.
    * def body =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant mark redeem b2c BxGy child percentage off__0008.7.
    * def body  =
    """
    {
