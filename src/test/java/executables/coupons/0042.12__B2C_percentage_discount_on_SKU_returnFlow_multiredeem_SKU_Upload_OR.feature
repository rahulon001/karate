Feature: b2c percentage discount on sku discount type return flow multi redeem __0042.4
  ...
  Background:
    ...
    * def sku_data1 = apiComponents["B2C_percentage_discount_on_SKU_discountType_responseData__0042.12"].skuData1
    * json result = callonce read("B2C_B2B_CouponCodeGeneration.feature@B2C_percentage_discount_SKU_Upload"){requestHeader: #(headerJson) , skuData: #(sku_data1)}
    * match result.response["skuCoupons"] != []
    * def sku_data2 = apiComponents["B2C_percentage_discount_on_SKU_discountType_responseData__0042.12"].skuData2
    * json result = callonce read("B2C_B2B_CouponCodeGeneration.feature@B2C_percentage_discount_SKU_Upload"){requestHeader: #(headerJson) , skuData: #(sku_data2)}
    * match result.response["skuCoupons"] != []
    * def sku_data3 = apiComponents["B2C_percentage_discount_on_SKU_discountType_responseData__0042.12"].skuData3
    * json result = callonce read("B2C_B2B_CouponCodeGeneration.feature@B2C_percentage_discount_SKU_Upload"){requestHeader: #(headerJson) , skuData: #(sku_data3)}
  ...
  Scenario: merchant verify b2c percentage discount on sku discount type __0042.4
    ...
    * def body =
    """
    {
      ...
      "tId": "xyzklj199",
      "billAmount": #(apiComponents["B2C_percentage_discount_on_SKU_discountType__0042.12"].billAmount),
      ...
      "couponsApplied": [
        ...
        "skuData": #(apiComponents["B2C_percentage_discount_on_SKU_discountType__0042.12"].skuData)
    }
    """
    ...
    When method post
    Then status 200
    * match response.data[0].discountType == apiComponents["B2C_percentage_discount_on_SKU_discountType_responseData__0042.12"].discountType1
    * match response.data[0].discount == apiComponents["B2C_percentage_discount_on_SKU_discountType_responseData__0042.12"].discount1
    * match response.discountedItems[0].skuId == apiComponents["B2C_percentage_discount_on_SKU_discountType_responseData__0042.12"].skuId1
    * match response.newBillAmount == apiComponents["B2C_percentage_discount_on_SKU_discountType_responseData__0042.12"].newBillAmount
  ...
  Scenario: merchant checkout b2c b2c percentage discount on sku discount type __0042.4
    * header x-client-type = "mpos"
    * def body =
    """
    {
  ...
  Scenario: merchant accept-order b2c b2c percentage discount on sku discount type __0042.4
  ...
  Scenario: merchant delivered-order b2c b2c percentage discount on sku discount type __0042.4
    * header x-client-type = "mpos"
    * def body  =
    """
    {
  ...
  Scenario: merchant return-order b2c B2C flat discount on SKU __0041.4.Return partial. modified cart not satisfying MBV
    ...
    * def body  =
    ...
    {
      "masId": "#(masid)",
      "discountedBillAmount": #(apiComponents["B2C_flat_discount_on_SKU_discountType_responseData__0041.16"].newBillAmount),
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_percentage_discount_on_SKU_discountType__0042.12"].skuData),
      "returnedItems": #(apiComponents["B2C_percentage_discount_on_SKU_discountType_return__0042.12"].skuData1)
    }
    """
  ...
  Scenario: merchant return-order b2c B2C flat discount on SKU __0041.4.Return partial. modified cart not satisfying MBV
    ...
    * def body  =
    """
    {
      ...
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_percentage_discount_on_SKU_discountType__0042.12"].skuData),
      "returnedItems": #(apiComponents["B2C_percentage_discount_on_SKU_discountType_return__0042.12"].skuData2)
    }
    """
    Given path '/coupons/v1/coupons/merchant/return-order'
    And request body
  ...
  Scenario: merchant return-order b2c B2C flat discount on SKU __0041.4
    ...
    * def body  =
    """
    {
      ...
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_percentage_discount_on_SKU_discountType__0042.12"].skuData),
      "returnedItems": #(apiComponents["B2C_percentage_discount_on_SKU_discountType__0042.12"].skuData)
    }
    """
    Given path '/coupons/v1/coupons/merchant/return-order'
    And request body
