Feature: BxGy B2B return flow __0007.3
  ...
  Background:
    ...
    * def result_b2c = callonce read("0007__B2C_BxGy_parent_percentage_off_mark_redeem_flow_discount_type.feature")
    * def result = callonce read("B2C_B2B_CouponCodeGeneration.feature@B2B_BxGy_percentage_parent_cart_redemption") {requestHeader: #(headerJson)}
