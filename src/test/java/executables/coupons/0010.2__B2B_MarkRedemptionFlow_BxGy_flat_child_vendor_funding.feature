Feature: BxGy B2B mark redeem flow parent __0010.2
  ...
  Background:
    ...
    * def b2c_discount_coupon_redemption = callonce read("0010__B2C_BxGy_child_flat_discount_mark_redeem_flow_discount_type.feature")
  ...
  Scenario: B2B coupon code getEligible __0010.2
  ...
  Scenario: B2B coupon code release getEligible __0010.2
    ...
    * def result = call read("B2C_B2B_CouponCodeGeneration.feature@B2B_BxGy_flat_child_cart_redemption") {requestHeader: #(headerJson)}
  ...
  Scenario: B2B coupon code checkout __0010.2
   ...
   Scenario: B2B coupon code deliver __0010.2.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: B2B coupon code mark redeem __0010.2.
    * def body  =
    """
    {
    }
