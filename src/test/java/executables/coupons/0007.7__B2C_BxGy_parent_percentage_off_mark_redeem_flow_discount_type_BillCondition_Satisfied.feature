Feature: BxGy_parent_percentage_off_mark_redeem_flow_discount_type __0007.7
  ...
  Background:
    ...
    * def bill_Amount = apiComponents["B2C_BxGy_parent_percentage_off_discountType__0007.7"].billAmount
    * json result = callonce read("B2C_B2B_CouponCodeGeneration.feature@BxGy_percentage_parent_cart_BillCondition"){requestHeader: #(headerJson) , billAmount: #(bill_Amount)}
    * assert bill_Amount>=apiComponents["B2C_BxGy_parent_percentage_off_discountType_responseData__0007.7"].minbillCondition
  ...
  Scenario: merchant checkout b2c BxGy parent percentage off__0007.7.
    * def body =
    """
      {
        "masId": "#(masid)",
  ...
  Scenario: merchant accept-order b2c BxGy parent percentage off__0007.7.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant delivered-order b2c BxGy parent percentage off__0007.7.
    * def body =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant mark redeem b2c BxGy parent percentage off__0007.7.
    * def body  =
    """
    {
