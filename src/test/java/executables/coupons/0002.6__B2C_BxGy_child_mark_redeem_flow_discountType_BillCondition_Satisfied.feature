@bxgy_child_BillCondition
Feature: BxGy child mark redeem flow __0002.6
  ...
  Background:
    ...
    * def bill_Amount = apiComponents["B2C_BxGy_child_discountType__0002.6"].billAmount
  #  * print #(bill_Amount)
    * json result = callonce read("B2C_B2B_CouponCodeGeneration.feature@BxGy_child_cart_BillCondition") {requestHeader: #(headerJson) , billAmount: #(bill_Amount)}
    ...
    * def discountAmount = apiComponents['B2C_BxGy_child_discountType__0002.6']['discountAmount']
    * def newBillAmount = apiComponents['B2C_BxGy_child_discountType_responseData__0002.6']['newBillAmount_satisfyingcondition']


  Scenario: merchant verify b2c BxGy child __0002.6.
    * def body =
    """
      {
        "masId": "#(masid)",
...
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_child_discountType_responseData__0002.6"].discountType1
  ...
  Scenario: merchant checkout b2c BxGy child __0002.6.
    * def body =
    """
      {
        "masId": "#(masid)",
...
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_child_discountType_responseData__0002.6"].discountType1
  ...
  Scenario: merchant accept-order b2c BxGy child __0002.6.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant delivered-order b2c BxGy child __0002.6.
    * def body =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant mark redeem b2c BxGy child __0002.6.
    * def body  =
    """
    {
