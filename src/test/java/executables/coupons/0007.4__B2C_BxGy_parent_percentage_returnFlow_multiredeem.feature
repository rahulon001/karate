Feature: BxGy parent percentage return flow multi redeem __0007.4
  ...
  Scenario: merchant verify b2c BxGy parent percentage  __0007.4
    ...
    * def body =
    ...
    When method post
    Then status 200
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_parent_percentage_off_discountType_responseData_mrpc__0007.4"].discountType1
    * match response.data[0].discount == apiComponents["B2C_BxGy_parent_percentage_off_discountType_responseData_mrpc__0007.4"].discount1
    * match response.discountedItems[0].skuId == apiComponents["B2C_BxGy_parent_percentage_off_discountType_responseData_mrpc__0007.4"].discountedItems_skuId1
    * match response.newBillAmount == apiComponents["B2C_BxGy_parent_percentage_off_discountType_responseData_mrpc__0007.4"].newBillAmount
  ...
  Scenario: merchant return-order b2c BxGy parent percentage  __0007.4
    ...
    * def body  =
    ...
    {
      "masId": "#(masid)",
      "discountedBillAmount": #(apiComponents["B2C_BxGy_parent_percentage_off_discountType_responseData_mrpc__0007.4"].newBillAmount),
