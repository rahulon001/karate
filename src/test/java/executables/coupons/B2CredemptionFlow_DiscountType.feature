@ignore @B2CredemptionFlow_discountType
Feature: Perform B2C redemption flow for discount type coupons
  ...
  Background:
    ...
    * def skuid = apiComponents['parameterValues']['B2CredemptionFlow_DiscountType']['skuid']
    * def skuQty = apiComponents['parameterValues']['B2CredemptionFlow_DiscountType']['skuQty']
    * def skuPrice = apiComponents['parameterValues']['B2CredemptionFlow_DiscountType']['skuPrice']
    * def skuid1 = apiComponents['parameterValues']['B2CredemptionFlow_DiscountType']['skuid1']
    * def skuQty1 = apiComponents['parameterValues']['B2CredemptionFlow_DiscountType']['skuQty1']
    * def skuPrice1 = apiComponents['parameterValues']['B2CredemptionFlow_DiscountType']['skuPrice1']
    * def skuid2 = apiComponents['parameterValues']['B2CredemptionFlow_DiscountType']['skuid2']
    * def skuQty2 = apiComponents['parameterValues']['B2CredemptionFlow_DiscountType']['skuQty2']
    * def skuPrice2 = apiComponents['parameterValues']['B2CredemptionFlow_DiscountType']['skuPrice2']
    * def skuid3 = apiComponents['parameterValues']['B2CredemptionFlow_DiscountType']['skuid3']
    * def skuQty3 = apiComponents['parameterValues']['B2CredemptionFlow_DiscountType']['skuQty3']
    * def skuPrice3 = apiComponents['parameterValues']['B2CredemptionFlow_DiscountType']['skuPrice3']
    * def skuid4 = apiComponents['parameterValues']['B2CredemptionFlow_DiscountType']['skuid4']
    * def skuQty4 = apiComponents['parameterValues']['B2CredemptionFlow_DiscountType']['skuQty4']
    * def skuPrice4 = apiComponents['parameterValues']['B2CredemptionFlow_DiscountType']['skuPrice4']
    * def skuid5 = apiComponents['parameterValues']['B2CredemptionFlow_DiscountType']['skuid5']
    * def skuQty5 = apiComponents['parameterValues']['B2CredemptionFlow_DiscountType']['skuQty5']
    * def skuPrice5 = apiComponents['parameterValues']['B2CredemptionFlow_DiscountType']['skuPrice5']
    * def discountAmount = apiComponents['parameterValues']['B2CredemptionFlow_DiscountType']['discountAmount']
    * def newBillAmount = apiComponents['parameterValues']['B2CredemptionFlow_DiscountType']['newBillAmount']


  Scenario Outline: merchant verify B2CRedemptionFlow_DiscountType.
  ...
  Scenario Outline: merchant checkout B2CRedemptionFlow_DiscountType.
    * header x-client-type = "mpos"
    * def body =
    """
    {
  ...
  Scenario Outline: merchant redeem B2CRedemptionFlow_DiscountType.
    * header x-client-type = "mpos"
    * def body  =
    """
    {
