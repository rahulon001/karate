Feature: BxGy child return flow multi redeem __0002.4
  ...
  Background:
    ...
    * def result = callonce read("B2C_B2B_CouponCodeGeneration.feature@BxGy_child_cart_mrpc")
  ...
  Scenario: merchant verify b2c BxGy child __0002.4
    ...
    * def body =
    """
    {
      ...
      "tId": "xyzklj199",
      "billAmount": #(apiComponents["B2C_BxGy_child_discountType_mrpc__0002.4"].billAmount),
      ...
      "couponsApplied": [
        ...
        "skuData": #(apiComponents["B2C_BxGy_child_discountType_mrpc__0002.4"].skuData)
    }
    """
    ...
    When method post
    Then status 200
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_child_discountType_responseData_mrpc__0002.4"].discountType1
    * match response.data[0].discount == apiComponents["B2C_BxGy_child_discountType_responseData_mrpc__0002.4"].discount1
    * match response.discountedItems[0].skuId == apiComponents["B2C_BxGy_child_discountType_responseData_mrpc__0002.4"].free_skuId1
    * match response.newBillAmount == apiComponents["B2C_BxGy_child_discountType_responseData_mrpc__0002.4"].newBillAmount
  ...
  Scenario: merchant checkout b2c BxGy child __0002.4
    * header x-client-type = "mpos"
    * def body =
    """
    {
...
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_child_discountType_responseData_mrpc__0002.4"].discountType1
  ...
  Scenario: merchant accept-order b2c BxGy child __0002.4
    * header x-client-type = "mpos"
    * def body  =
    """
    {
  ...
  Scenario: merchant delivered-order b2c BxGy child __0002.4
    * header x-client-type = "mpos"
    * def body  =
    """
    {
  ...
  Scenario: merchant return-order b2c BxGy child __0002.4
    * header x-client-type = "mpos"
    * def body  =
    """
    {
      "masId": "#(masid)",
      "discountedBillAmount": #(apiComponents["B2C_BxGy_child_discountType_responseData_mrpc__0002.4"].newBillAmount),
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_BxGy_child_discountType_mrpc__0002.4"].skuData),
      "returnedItems": #(apiComponents["B2C_BxGy_child_discountType_mrpc__0002.4"].skuData)
    }
    """
  ...
  Scenario: merchant order-returned(cancel) b2c BxGy child __0002.4
    * header x-client-type = "mpos"
    * def body =
    """
    {
