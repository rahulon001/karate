...
#B2C_flat_discount_on_SKU coupon with min bill amount specified and cart bill amount>=min bill amount. minbill=200
Feature: B2C flat discount on sku mark redeem flow __0041.6
  ...
  Background:
    ...
    * def bill_Amount = apiComponents["B2C_flat_discount_on_SKU_discountType__0041.6"].billAmount
  #  * print #(bill_Amount)
    * def result = callonce read("B2C_B2B_CouponCodeGeneration.feature@B2C_flat_discount_on_SKU_BillCondition") {requestHeader: #(headerJson) , billAmount: #(bill_Amount)}
  ...
  Scenario: merchant verify b2c B2C flat discount on sku __0041.6.
    * def body =
    """
      {
        "masId": "#(masid)",
  ...
  Scenario: merchant checkout b2c B2C flat discount on sku __0041.6.
    * def body =
    """
      {
        "masId": "#(masid)",
  ...
  Scenario: merchant accept-order b2c B2C flat discount on sku __0041.6.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant delivered-order b2c B2C flat discount on sku __0041.6.
    * def body =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant mark redeem b2c B2C flat discount on sku __0041.6.
    * def body  =
    """
    {
