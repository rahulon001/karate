Feature: BxGy_parent_percentage_off_mark_redeem_flow_discount_type __0009.7
  ...
  Background:
    ...
    * def sku_price = apiComponents["B2C_BxGy_parent_flat_off_discountType_responseData__0009.7"].skuPrice1
    * def bill_Amount = apiComponents["B2C_BxGy_parent_flat_off_discountType_responseData__0009.7"].billAmount_notsatisfyingcondition
