  ...
  Scenario: merchant return-order b2c B2C flat discount on SKU __0041.4.Return partial. modified cart not satisfying MBV
    ...
    * def body  =
    """
    {
      ...
      "originalCart": #(apiComponents["B2C_flat_discount_on_SKU_discountType__0041.16"].skuData),
      "returnedItems": #(apiComponents["B2C_flat_discount_on_SKU_discountType_return__0041.16"].skuData1)
    }
    """
  ...
  Scenario: merchant return-order b2c B2C flat discount on SKU __0041.4.Return partial. modified cart not satisfying MBV
    ...
    * def body  =
    """
    {
      ...
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_flat_discount_on_SKU_discountType__0041.16"].skuData),
      "returnedItems": #(apiComponents["B2C_flat_discount_on_SKU_discountType_return__0041.16"].skuData2)
    }
    """
    Given path '/coupons/v1/coupons/merchant/return-order'
    And request body
  ...
  Scenario: merchant return-order b2c B2C flat discount on SKU __0041.4
    ...
    * def body  =
    """
    {
      ...
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_flat_discount_on_SKU_discountType__0041.16"].skuData),
      "returnedItems": #(apiComponents["B2C_flat_discount_on_SKU_discountType__0041.16"].skuData)
    }
    """
    Given path '/coupons/v1/coupons/merchant/return-order'
    And request body
