Feature: BxGy child percentage off return order flow discount type __0008.1
  ...
  Background:
    ...
    * json result = callonce read("B2C_B2B_CouponCodeGeneration.feature@BxGy_percentage_child_cart_BillCondition")
  ...
  Scenario: merchant verify b2c BxGy child __0008.1.
    * def body =
    """
      {
        "masId": "#(masid)",
        ...
        "tId": "xyzklj199",
        "billAmount": #(apiComponents["B2C_BxGy_child_percentage_off_discountType__0008.7"].billAmount),
        "couponCodes": "#(couponCode1)",
        "skuData": #(apiComponents["B2C_BxGy_child_percentage_off_discountType__0008.7"].skuData)
      }
    """
    ...
    When method post
    Then status 200
    * match response.data[0].discountType == apiComponents["B2C_BxGy_child_percentage_off_discountType_responseData__0008.7"].discountType1
    * match response.data[0].discount == apiComponents["B2C_BxGy_child_percentage_off_discountType_responseData__0008.7"].discount1
    * match response.discountedItems[0].skuId == apiComponents["B2C_BxGy_child_percentage_off_discountType_responseData__0008.7"].discountedItems_skuId1
    * match response.newBillAmount == apiComponents["B2C_BxGy_child_percentage_off_discountType_responseData__0008.7"].newBillAmount
  ...
  Scenario: merchant checkout b2c BxGy child __0008.7.1.
    * def body =
    """
      {
        "masId": "#(masid)",
  ...
  Scenario: merchant accept-order b2c BxGy child __0008.7.1.
  ...
  Scenario: merchant delivered-order b2c BxGy child __0008.7.1.
    * def body =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant return-order b2c BxGy child __0008.7.1.Partial return negative case
    * header x-client-type = "mpos"
    * def body  =
    """
    {
      "masId": "#(masid)",
      "discountedBillAmount": #(apiComponents["B2C_BxGy_child_percentage_off_discountType_responseData__0008.7"].newBillAmount),
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_BxGy_child_percentage_off_discountType__0008.7"].skuData),
      "returnedItems": #(apiComponents["B2C_BxGy_child_percentage_off_discountType_return__0008.7"].skuData1)
    }
    """
  ...
  Scenario: merchant return-order b2c BxGy child __0008.7.1.Partial return negative case
    ...
    * def body  =
    """
    {
      ...
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_BxGy_child_percentage_off_discountType__0008.7"].skuData),
      "returnedItems": #(apiComponents["B2C_BxGy_child_percentage_off_discountType_return__0008.7"].skuData2)
    }
    """
    Given path '/coupons/v1/coupons/merchant/return-order'
    And request body
  ...
  Scenario: merchant return-order b2c BxGy child __0008.7.1.
    * header x-client-type = "mpos"
    * def body  =
    """
    {
      ...
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_BxGy_child_percentage_off_discountType__0008.7"].skuData),
      "returnedItems": #(apiComponents["B2C_BxGy_child_percentage_off_discountType__0008.7"].skuData)
    }
    """
    Given path '/coupons/v1/coupons/merchant/return-order'
    And request body
...
#    * call sleep 30
  ...
  Scenario: merchant order-returned b2c BxGy child __0008.7.1.
