...
Feature: b2c percentage discount on sku mark redeem flow __0042.7
  ...
  Background:
    ...
    * def sku_price = apiComponents["B2C_percentage_discount_on_SKU_discountType_responseData__0042.6"].skuPrice1
    * def bill_Amount = apiComponents["B2C_percentage_discount_on_SKU_discountType_responseData__0042.6"].billAmount_notsatisfyingcondition
  #  * print #(bill_Amount)
  ...
  Scenario: Generate Coupon code b2c b2c percentage discount on sku __0042.7
