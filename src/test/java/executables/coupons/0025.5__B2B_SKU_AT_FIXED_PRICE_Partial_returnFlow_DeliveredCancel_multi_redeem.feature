Feature: B2B_SKU_AT_FIXED_PRICE partial return flow multi redeem __0025.5
  ...
  Background:
    ...
    * def sku_data = apiComponents.B2B_SKU_AT_FIXED_PRICE_coupon_redemption__0025.skuData
    ...
    * print "skuID_index_811143212226>", skuID_index_811143212226
    * def skuID_index_811143212228 = skuID.indexOf("811143212228")
    * print "skuID_index_811143212228>", skuID_index_811143212228
    * def skuID_index_811143212227 = skuID.indexOf("811143212227")
    * print "skuID_index_811143212227>", skuID_index_811143212227

    * def couponCode1 = result.response["skuCoupons"][skuID_index_811143212226]["coupons"][0]["couponCode"]
    * print "couponCode1>", couponCode1
    * def couponCode2 = result.response["skuCoupons"][skuID_index_811143212228]["coupons"][0]["couponCode"]
    * print "couponCode2>", couponCode2
    * def couponCode3 = result.response["skuCoupons"][skuID_index_811143212227]["coupons"][0]["couponCode"]
    * print "couponCode3>", couponCode3

    * assert result.response["skuCoupons"][skuID_index_811143212226]["coupons"][0]["couponQty"] == apiComponents.B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025.couponQty_mr_811143212226
    * assert result.response["skuCoupons"][skuID_index_811143212228]["coupons"][0]["couponQty"] == apiComponents.B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025.couponQty_mr_811143212228
    * assert result.response["skuCoupons"][skuID_index_811143212227]["coupons"][0]["couponQty"] == apiComponents.B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025.couponQty_mr_811143212227
    
    * def couponCode1 = result.response["skuCoupons"][skuID_index_811143212226]["coupons"][0]["couponCode"]
    * def couponQuantity1 = result.response["skuCoupons"][skuID_index_811143212226]["coupons"][0]["couponQty"]
    * def couponCode2 = result.response["skuCoupons"][skuID_index_811143212228]["coupons"][0]["couponCode"]
    * def couponQuantity2 = result.response["skuCoupons"][skuID_index_811143212228]["coupons"][0]["couponQty"]
    * def couponCode3 = result.response["skuCoupons"][skuID_index_811143212227]["coupons"][0]["couponCode"]
    * def couponQuantity3 = result.response["skuCoupons"][skuID_index_811143212227]["coupons"][0]["couponQty"]
    ...
    * assert result.response["skuCoupons"][skuID_index_811143212226]["coupons"][0].discount == apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].discount_mr_811143212226
    * assert result.response["skuCoupons"][skuID_index_811143212228]["coupons"][0].discount == apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].discount_mr_811143212228
    * assert result.response["skuCoupons"][skuID_index_811143212227]["coupons"][0].discount == apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].discount_mr_811143212227

    * assert result.response["skuCoupons"][skuID_index_811143212226]["coupons"][0].quantity == apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].sku_quantity_per_unit_mr_811143212226
    * assert result.response["skuCoupons"][skuID_index_811143212228]["coupons"][0].quantity == apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].sku_quantity_per_unit_mr_811143212228
    * assert result.response["skuCoupons"][skuID_index_811143212227]["coupons"][0].quantity == apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].sku_quantity_per_unit_mr_811143212227
  ...
  Scenario: B2B_SKU_AT_FIXED_PRICE checkout partial return flow multi redeem __0025.5.
    * def coupon_id_811143212226 = db.readRows("SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212226+ "\')")
    * def coupon_id_811143212228 = db.readRows("SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212228+ "\')")
    * def coupon_id_811143212227 = db.readRows("SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212227+ "\')")

    * def coupon_code_status = db.readRows("SELECT * FROM FC_MERCHANT_COUPONS WHERE B2B_COUPON_ID IN (\'" +coupon_id_811143212226[0].ID+ "\',\'" +coupon_id_811143212228[0].ID+ "\',\'" +coupon_id_811143212227[0].ID+ "\') and status='hold'")
  ...
  Scenario: B2B_SKU_AT_FIXED_PRICE checkout partial return flow multi redeem __0025.5.
    ...
    * assert response.data[coupon_code.indexOf(couponCode1)].discount == apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].discount_mr_811143212226
    * assert response.data[coupon_code.indexOf(couponCode2)].discount == apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].discount_mr_811143212228
    * assert response.data[coupon_code.indexOf(couponCode3)].discount == apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].discount_mr_811143212227

    * assert response.data[coupon_code.indexOf(couponCode1)].quantity == apiComponents.B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025.couponQty_mr_811143212226
    * assert response.data[coupon_code.indexOf(couponCode2)].quantity == apiComponents.B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025.couponQty_mr_811143212228
    * assert response.data[coupon_code.indexOf(couponCode3)].quantity == apiComponents.B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025.couponQty_mr_811143212227

  Scenario: B2B_SKU_AT_FIXED_PRICE delivered partial return flow multi redeem __0025.5
  ...
  Scenario: B2B_SKU_AT_FIXED_PRICE delayed cancel partial return flow multi redeem __0025.5
      # redemption count
    * def redeem_quantity_811143212226 = db.readRows("SELECT QUANTITY FROM B2B_COUPON_REDEMPTION WHERE B2B_COUPON_ID IN (SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212226+ "\')) and masid=\'" +masid+ "\'")
    * def redeem_quantity_811143212227 = db.readRows("SELECT QUANTITY FROM B2B_COUPON_REDEMPTION WHERE B2B_COUPON_ID IN (SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212227+ "\')) and masid=\'" +masid+ "\'")
    * def redeem_quantity_811143212228 = db.readRows("SELECT QUANTITY FROM B2B_COUPON_REDEMPTION WHERE B2B_COUPON_ID IN (SELECT ID FROM B2B_COUPON bbc WHERE SKU_ID IN (\'" +811143212228+ "\')) and masid=\'" +masid+ "\'")
  ...
  Scenario: B2B_SKU_AT_FIXED_PRICE redeem partial return flow multi redeem __0025.5
    * def body  =
    """
    {
    }
  ...
  Scenario: B2B_SKU_AT_FIXED_PRICE checkout of cancelled coupons in partial return flow multi redeem __0025.5
    * def body =
    """
      {
      "masId": "#(masid)",
      ...
      "skuData": [
          ...
          {
            "skuId": "#(sku_data[2].skuId)",
            "skuQty":  #(sku_data[2].skuQty),
            "skuPrice": #(sku_data[2].skuPrice),
            "articleId" : "lol",
            "coupons" : [{
                "couponCode": #(couponCode2),
                "quantity" : #(couponQuantity2)
  ...
  Scenario: Switching off the features __0025.5.
