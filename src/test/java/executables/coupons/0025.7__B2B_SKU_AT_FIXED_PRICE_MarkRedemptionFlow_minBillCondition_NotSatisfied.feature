Feature: B2B_SKU_AT_FIXED_PRICE MarkRedemptionFlow __0025.7
...
#    * assert result.response["skuCoupons"][skuID_index_811143212228]["coupons"][0].discount == apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].discount_811143212228
  ...
  Scenario: B2B_SKU_AT_FIXED_PRICE checkout partial return flow __0025.7.
 ...
 #   * match parseInt(redeem_count_811143212228_c[0].REDEEM_COUNT) == parseInt(redeem_count_811143212228[0].REDEEM_COUNT + 1)
  ...
  Scenario: B2B_SKU_AT_FIXED_PRICE checkout partial return flow __0025.7.
    ...
    * assert response.discountAmount == apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].discountAmount_mbv
    * assert response.newBillAmount == apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].newBillAmount_mbv
...
#    * assert response.data[coupon_code.indexOf(couponCode3)].discount == apiComponents["B2B_SKU_AT_FIXED_PRICE_coupon_redemption_responseData__0025"].discount_811143212228
  ...
  Scenario: B2B_SKU_AT_FIXED_PRICE delivered partial return flow __0025.7
