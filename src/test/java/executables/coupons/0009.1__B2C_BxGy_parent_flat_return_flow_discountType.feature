Feature: BxGy child return order flow __0009.1
  ...
  Scenario: merchant verify b2c BxGy child __0009.1.
    * def body =
    """
      {
        "masId": "#(masid)",
...
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_parent_flat_off_discountType_responseData__0009"].discountType1
  ...
  Scenario: merchant checkout b2c BxGy child __0009.1.
    * def body =
    """
      {
        "masId": "#(masid)",
...
#    * match response.data[0].discountType == apiComponents["B2C_BxGy_parent_flat_off_discountType_responseData__0009"].discountType1
  ...
  Scenario: merchant accept-order b2c BxGy child __0009.1.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant delivered-order b2c BxGy child __0009.1.
    * def body =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant return-order b2c BxGy child __0009.1.Partial return negative case
    * header x-client-type = "mpos"
    * def body  =
    """
    {
      "masId": "#(masid)",
      "discountedBillAmount": #(apiComponents["B2C_BxGy_parent_flat_off_discountType_responseData__0009"].newBillAmount),
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_BxGy_parent_flat_off_discountType__0009"].skuData),
      "returnedItems": #(apiComponents["B2C_BxGy_parent_flat_off_discountType_return__0009"].skuData1)
    }
    """
  ...
  Scenario: merchant return-order b2c BxGy child __0009.1.Partial return negative case
    ...
    * def body  =
    """
    {
      ...
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_BxGy_parent_flat_off_discountType__0009"].skuData),
      "returnedItems": #(apiComponents["B2C_BxGy_parent_flat_off_discountType_return__0009"].skuData2)
    }
    """
    Given path '/coupons/v1/coupons/merchant/return-order'
    And request body
  ...
  Scenario: merchant return-order b2c BxGy child __0009.1.
    * header x-client-type = "mpos"
    * def body  =
    """
    {
      ...
      "couponCodesApplied":[#(couponCode1)],
      "originalCart": #(apiComponents["B2C_BxGy_parent_flat_off_discountType__0009"].skuData),
      "returnedItems": #(apiComponents["B2C_BxGy_parent_flat_off_discountType__0009"].skuData)
    }
    """
    Given path '/coupons/v1/coupons/merchant/return-order'
    And request body
...
#    * call sleep 30
  ...
  Scenario: merchant order-returned b2c BxGy child __0009.1.
    * header x-client-type = "mpos"
    * def body =
    """
    {
