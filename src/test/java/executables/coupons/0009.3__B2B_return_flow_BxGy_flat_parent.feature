Feature: BxGy B2B mark redeem flow parent __0009.3
  ...
  Background:
    ...
    * def result = callonce read("0009__B2C_BxGy_parent_flat_discount_mark_redeem_flow_discount_type.feature")
    * def result = callonce read("B2C_B2B_CouponCodeGeneration.feature@B2B_BxGy_flat_parent_cart") {requestHeader: #(headerJson)}
