Feature: BxGy_child_flat_off_mark_redeem_flow_discount_type __0010.7
  ...
  Scenario: merchant verify b2c BxGy child percentage off __0010.7.
    * def body =
    """
      {
        "masId": "#(masid)",
  ...
  Scenario: merchant checkout b2c BxGy child percentage off__0010.7.
    * def body =
    """
      {
        "masId": "#(masid)",
  ...
  Scenario: merchant accept-order b2c BxGy child percentage off__0010.7.
    * def body  =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant delivered-order b2c BxGy child percentage off__0010.7.
    * def body =
    """
    {
      "couponCodes":[#(couponCode1)],
  ...
  Scenario: merchant mark redeem b2c BxGy child percentage off__0010.7.
    * def body  =
    """
    {
